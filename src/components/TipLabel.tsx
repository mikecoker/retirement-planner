...
const DEFINITIONS: Record<string, string> = {
  ...
  'Retirement spending smile': 'Models higher ordinary/discretionary spending early in retirement and lower spending later. Healthcare and LTC are not adjusted by this setting.',
  'Early retirement change (%)': 'Percent adjustment applied to base and discretionary spending from retirement until the late retirement age.',
  'Late retirement age': 'Age when the late-retirement spending adjustment starts.',
  'Late retirement change (%)': 'Percent adjustment applied to base and discretionary spending from the late retirement age onward.',
